...
[![CI](https://github.com/your-org/gaejo/actions/workflows/ci.yml/badge.svg)](https://github.com/your-org/gaejo/actions/workflows/ci.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Python 3.9+](https://img.shields.io/badge/python-3.9+-blue.svg)](https://www.python.org)

```
"우리는 정확도를 4.7%p 정도 끌어올렸습니다"   →   "제안 모델, 정확도 4.7%p 향상"
...
```bash
pip install gaejo[all]      # kiwipiepy + anthropic 포함
# 또는 부분 설치
pip install gaejo[kiwi]     # 판별기·메트릭만 (LLM 변환 제외)
```
...
gaejo transform "정확도를 4.7%p 정도 끌어올렸습니다"
# → 제안 모델, 정확도 4.7%p 향상
```
...
```python
from gaejo import classify_ending, score_text, build_messages
...
out = transform("기존 방법은 데이터가 많이 필요했는데 저희는 적게 써도 됩니다", unit="bullet")
objective(orig, out)   # 객관 메트릭(개조식 종결 비율·길이·안티패턴)
